...
ENV KNOWAGE_SDK_ENGINE ${KNOWAGE_CORE_ENGINE}sdk
ENV KNOWAGE_SDK_URL ${KNOWAGE_OW2_BASE_URL}/${KNOWAGE_SDK_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}${FILEEXTENSION}
...
RUN apt-get update 
RUN apt-get install -y wget coreutils unzip mysql-client  && rm -rf /var/lib/apt/lists/* 
