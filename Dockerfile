...
ENV KNOWAGE_REPO_VERSION 6.4.4
...
RUN wget "${KNOWAGE_CORE_URL}" && \
       unzip ${KNOWAGE_CORE_ENGINE}.zip -d ${KNOWAGE_CORE_ENGINE} && \
       rm ${KNOWAGE_CORE_ENGINE}.zip
       
RUN wget "${KNOWAGE_BIRTREPORT_URL}" && \
       unzip ${KNOWAGE_BIRTREPORT_ENGINE}.zip -d ${KNOWAGE_BIRTREPORT_ENGINE} && \
       rm ${KNOWAGE_BIRTREPORT_ENGINE}.zip
       
RUN wget "${KNOWAGE_COCKPIT_URL}" && \
       unzip ${KNOWAGE_COCKPIT_ENGINE}.zip -d ${KNOWAGE_COCKPIT_ENGINE} && \
       rm ${KNOWAGE_COCKPIT_ENGINE}.zip
       
RUN wget "${KNOWAGE_COMMONJ_URL}" && \
       unzip ${KNOWAGE_COMMONJ_ENGINE}.zip -d ${KNOWAGE_COMMONJ_ENGINE} && \
       rm ${KNOWAGE_COMMONJ_ENGINE}.zip
       
RUN wget "${KNOWAGE_DATAMINING_URL}" && \
       unzip ${KNOWAGE_DATAMINING_ENGINE}.zip -d ${KNOWAGE_DATAMINING_ENGINE} && \
       rm ${KNOWAGE_DATAMINING_ENGINE}.zip
       
RUN wget "${KNOWAGE_GEOREPORT_URL}" && \
       unzip ${KNOWAGE_GEOREPORT_ENGINE}.zip -d ${KNOWAGE_GEOREPORT_ENGINE} && \
       rm ${KNOWAGE_GEOREPORT_ENGINE}.zip
       
RUN wget "${KNOWAGE_JASPERREPORT_URL}" && \
       unzip ${KNOWAGE_JASPERREPORT_ENGINE}.zip -d ${KNOWAGE_JASPERREPORT_ENGINE} && \
       rm ${KNOWAGE_JASPERREPORT_ENGINE}.zip
       
RUN wget "${KNOWAGE_KPI_URL}" && \
       unzip ${KNOWAGE_KPI_ENGINE}.zip -d ${KNOWAGE_KPI_ENGINE} && \
       rm ${KNOWAGE_KPI_ENGINE}.zip
       
RUN wget "${KNOWAGE_META_URL}" && \
       unzip ${KNOWAGE_META_ENGINE}.zip -d ${KNOWAGE_META_ENGINE} && \
       rm ${KNOWAGE_META_ENGINE}.zip
       
RUN wget "${KNOWAGE_NETWORK_URL}" && \
       unzip ${KNOWAGE_NETWORK_ENGINE}.zip -d ${KNOWAGE_NETWORK_ENGINE} && \
       rm ${KNOWAGE_NETWORK_ENGINE}.zip
       
RUN wget "${KNOWAGE_QBE_URL}" && \
       unzip ${KNOWAGE_QBE_ENGINE}.zip -d ${KNOWAGE_QBE_ENGINE} && \
       rm ${KNOWAGE_QBE_ENGINE}.zip
       
RUN wget "${KNOWAGE_SVGVIEWER_URL}" && \
       unzip ${KNOWAGE_SVGVIEWER_ENGINE}.zip -d ${KNOWAGE_SVGVIEWER_ENGINE} && \
       rm ${KNOWAGE_SVGVIEWER_ENGINE}.zip
       
RUN wget "${KNOWAGE_TALEND_URL}" && \
       unzip ${KNOWAGE_TALEND_ENGINE}.zip -d ${KNOWAGE_TALEND_ENGINE} && \
       rm ${KNOWAGE_TALEND_ENGINE}.zip
       
RUN wget "${KNOWAGE_WHATIF_URL}" && \
       unzip ${KNOWAGE_WHATIF_ENGINE}.zip -d ${KNOWAGE_WHATIF_ENGINE} && \
       rm ${KNOWAGE_WHATIF_ENGINE}.zip
